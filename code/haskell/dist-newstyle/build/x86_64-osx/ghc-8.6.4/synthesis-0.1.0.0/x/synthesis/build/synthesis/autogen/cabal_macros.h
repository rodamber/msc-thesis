...
/* package synthesis-0.1.0.0 */
#ifndef VERSION_synthesis
#define VERSION_synthesis "0.1.0.0"
#endif /* VERSION_synthesis */
#ifndef MIN_VERSION_synthesis
#define MIN_VERSION_synthesis(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_synthesis */
...
#define CURRENT_COMPONENT_ID "synthesis-0.1.0.0-inplace-synthesis"
