...
% FIXME: Does not automatically capitalize the first word at the start of the
% sentence.

\acrodef{CEGIS}{counterexample guided inductive search}
\acrodef{DSL}{Domain Specific Language}
\acrodef{IO}{\textit{input-output}}
\acrodef{PBE}{Programming by Examples}
\acrodef{PBD}{Programming by Demonstration}
