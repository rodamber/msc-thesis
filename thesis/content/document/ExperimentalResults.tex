...
%% later |--v
% number of constants needed of each type

% ranking needed, especially for few examples: far fetched constants and
% "identity components" make everything possible
% substring indexes can not be the same
% constants cannot be equal to the output
% remove example with unicode (example-67.json)
% definitely interesting to check the case where constants are limited
