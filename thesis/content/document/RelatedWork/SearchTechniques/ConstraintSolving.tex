...
Imagine we are interested in a program \todo{<insert interesting bit
...
% \citeauthor{Gulwani2017} describe the SKETCH system as a ``compiler [that]
% relies on a SAT solver to materialize some language constructs''.
...
% TODO: SyPet and FrAngel

% Conflict-driven, distinguishing inputs

% Solver-Aided Program Synthesis: Reference Rosette and SMTEN

% Highlights and drawbacks; comparison between high level approaches such as
% solver aided synthesizers and enconding the problem in sat/smt
