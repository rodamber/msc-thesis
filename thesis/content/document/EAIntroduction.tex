...
\subsection{OutSystems and \Glsfmtfull{pbe}}
...
\footnotetext{\url{https://www.outsystems.com/platform/}}
To that effect, the kind of programs we are interested in are expressions in the
OutSystems language.\footnotemark
\footnotetext{\url{https://success.outsystems.com/Documentation/11/Reference/OutSystems_Language/Logic/Expressions/}}
