...
Rename to preliminaries. May be added as an appendix? Well, it's not like I'm
lacking space, but usually that's how they do it in books (not sure about
theses, though).
...
* config :noexport:
#+COLUMNS: %35ITEM %7CONTENT %7EXAMPLES %7RELWORK
